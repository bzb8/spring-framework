 ...
 *
 * {@link ImportSelector} 的变体，在处理完所有 {@code @Configuration} beans 后运行。当选定的导入是 {@code @Conditional} 时，这种类型的选择器特别有用。
 *
 * <p>Implementations can also extend the {@link org.springframework.core.Ordered}
 * interface or use the {@link org.springframework.core.annotation.Order} annotation to
 * indicate a precedence against other {@link DeferredImportSelector DeferredImportSelectors}.
 *
 * 实现还可以扩展 {@link org.springframework.core.Ordered} 接口或使用 {@link org.springframework.core.annotation.Order} 注解
